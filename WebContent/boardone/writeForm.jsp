...
<body bgcolor="<%=bodyback_c%>">
	...
	<form method="post" name="writeForm" action="writeProc.jsp"
		...
		<table width="400" border="1" cellpadding="0" cellspacing="0"
			...
			<tr>
				<td align="center" width="70" bgcolor="<%=value_c%>">이름</td>
				<td width="330"><input type="text" size="12" maxlength="12"
					name="writer" /></td>
			</tr>
			<tr>
				<td align="center" width="70" bgcolor="<%=value_c%>">이메일</td>
 ...
 %> <input
			...
			<tr>
				<td align="center" width="70" bgcolor="<%=value_c%>">내용</td>
				<td width="330"><textarea name="content" rows="13" cols="50"></textarea>
				</td>
			</tr>
			<tr>
				<td align="center" width="100" bgcolor="<%=value_c%>">비밀번호</td>
			...
			<tr>
				<td align="center" colspan="2" bgcolor="<%=value_c%>"><input
					...
					type="button" value="목록" onClick="window.location='list.jsp'" /></td>
			</tr>
		</table>
	</form>
	<!-- 예외처리 -->
